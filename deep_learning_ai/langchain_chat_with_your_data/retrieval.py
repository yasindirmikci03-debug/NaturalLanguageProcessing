...
# Adressing Diversity: Maximum marginal relevance
...
docs_mmr = vectordb.max_marginal_relevance(question,k=3)

print(docs_mmr[0].page_content[:100])
print(docs_mmr[1].page_content[:100])


# Adressing Specificity: working with metadata
...
# Adressing Specificity : working with metadata using self-query retriever
